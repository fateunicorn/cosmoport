...
@EnableJpaRepositories(basePackages = "com.space.repository") //What a "Jpa"
...
//        dataSource.setPassword("root0000");
        return dataSource;
    }
    ...
    public JdbcTemplate jdbcTemplate() {
        return new JdbcTemplate(dataSource()); //or dataSourceForTests ???
    }
}